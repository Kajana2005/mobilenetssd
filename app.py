...
lineaccesstoken = 'nffSwLOWJs2fCY82dxX9nZJ7NLS0qCTen1W4RfUOjaiLWWqxF37lwtTdpEZ8ReVShfKYzyirdkZGhiJWOZW5RN+IO9CCB1NnYYglkSrCUdo5tn7yUoG+PJvxOFV4vW/5nNabJHDoTIsqBy1Zc7E9OgdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดีค่ะ" :
            replyObj = TextSendMessage(text="สวัสดียามเช้าค่ะ ยินดีต้อนรับ เมาท์ข่าวด่วนจึ๋งค่ะ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "สนใจอ่านข่าวค่ะ" :
            replyObj = TextSendMessage(text="อยากได้ข่าวแบบใหนค่ะ")
            line_bot_api.reply_message(rtoken, replyObj)
       elif msg == "ข่าวที่มาแรงในตอนนี้" : 
